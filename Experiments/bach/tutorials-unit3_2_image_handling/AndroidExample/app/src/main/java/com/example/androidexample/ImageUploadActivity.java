...
public class ImageUploadActivity extends AppCompatActivity {
    ...
    private void uploadImage(){
        ...
        MultipartRequest multipartRequest = new MultipartRequest(
                ...
                response -> {
                    // Handle response
                    Toast.makeText(getApplicationContext(), "Image uploaded successfully: " + response,Toast.LENGTH_LONG).show();
                    Log.d("Upload", "Response: " + response);
                },
                error -> {
                    // Handle error
                    Toast.makeText(getApplicationContext(), "Error uploading image: " + error.getMessage(),Toast.LENGTH_LONG).show();
    ...
    private byte[] convertImageUriToBytes(Uri imageUri) {
        try {
            ...
            e.printStackTrace();
            Toast.makeText(getApplicationContext(), "Error converting image to byte array", Toast.LENGTH_SHORT).show();
        }
        return null;
    }
